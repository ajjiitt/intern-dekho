        ...
        <div className='p-4' style={{transition:"box-shadow .25s, -webkit-box-shadow .25s",boxShadow:" 0 2px 2px 0 rgba(0,0,0,0.14),0 3px 1px -2px rgba(0,0,0,0.12),0 1px 5px 0 rgba(0,0,0,0.2)"}}>
            <div className='flex flex-row justify-between gap-1'>
                ...
                <div className='flex flex-col gap-2 basis-6/7'>
                    <div className=' shadow-black-100  rounded-md p-1 md:pt-2 flex items-center justify-start font-strong text-xl  '>Full stack Developement intern</div>
                    
                    <div className='flex flex-col sm:flex-row justify-between gap-1 '>
                        <div className=' shadow-black-100  rounded-md p-1 flex items-center justify-start font-semiStrong'>Amazon</div>
                        <div className='flex items-center justify-start   shadow-black-100 font-semiStrong'>Mumbai,Maharashtra</div>
                        <div className='flex items-center justify-start   shadow-black-100 font-semiStrong'>Salary : 7 LPA</div>
                    </div>
